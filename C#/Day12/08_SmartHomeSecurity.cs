...
namespace SmartHomeSecurity
{
    ...
    public class MotionSensor
    {
        ...
        public void DetectIntruder(string zoneName)
        {
            ...
            if (OnEmergency != null)
            {
                OnEmergency(zoneName); // string value = Main Lobby✅ or panicSequence ❌ because delegate holds method references, not data
            }
        }
    }
    ...
    class SmartHomeSecurityCaller
    {
        public static void SmartHomeSecurityCallerMethod()
        {
